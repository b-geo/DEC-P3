...
select
    ...
    case
		when stg_events.firstpractice is not null then
			try_to_timestamp(
    ...
    case
		when stg_events.secondpractice is not null then
			try_to_timestamp(
    ...
    case
		when stg_events.thirdpractice is not null then
			try_to_timestamp(
    ...
    case
        when stg_events.qualifying is not null then
            try_to_timestamp(
    ...
    case
        when stg_events.sprintqualifying is not null then
            try_to_timestamp(
    ...
    case
        when stg_events.sprint is not null then
            try_to_timestamp(
